...
const allItems = [
  ...
  },
  {
    ...
    parentId: "1",
    text:
      "<h3>SMALLEST</h3><p>Mercury is the smallest planet in our solar system—only slightly larger than Earth's Moon.</p>" +
  ...
  },
  {
    ...
    parentId: "5",
    text:
      "<h3>THIRD ROCK</h3><p>Earth orbits our Sun, a star. Earth is the third planet from the Sun at a distance of about 93 million miles (150 million km).</p>" +
  ...
  },
  {
    ...
    parentId: "8",
    text:
      "<h3>FIFTH PLANET FROM OUR STAR</h3><p>Jupiter orbits about 484 million miles (778 million kilometers) or 5.2 Astronomical Units (AU) from our Sun (Earth is one AU from the Sun).</p>" +
